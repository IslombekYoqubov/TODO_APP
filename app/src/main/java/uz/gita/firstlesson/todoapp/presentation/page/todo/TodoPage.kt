...
import uz.gita.firstlesson.todoapp.databinding.PageTodoBinding
...
import uz.gita.firstlesson.todoapp.presentation.factories.TodoViewModelFactory
...
class TodoPage : Fragment(R.layout.page_todo) {
    ...
    private val viewModel: TodoViewModel by viewModels {
        TodoViewModelFactory(AppRepositoryImpl.getInstance())
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemTouchHelper = ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                viewModel.changeTaskStatus(task.id, 1)
            }
        })
        ...
        viewModel.tasksEntityLiveData.observe(viewLifecycleOwner, tasksEntityObserver)
    ...
    private val tasksEntityObserver = Observer<List<TaskEntity>> {
